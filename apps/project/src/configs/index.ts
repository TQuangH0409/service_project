...
export const configs = {
    service: "project",
    environment: process.env.CA_PROJECT_ENVIRONMENT || "dev",
    app: {
        prefix: "/api/v1",
        host: process.env.CA_PROJECT_HOST_NAME || "0.0.0.0",
        port: process.env.CA_PROJECT_PORT_NUMBER || "6804",
    },
    mongo: {
        addresses: process.env.CA_PROJECT_MONGO_ADDRESSES || "rs0",
        username: process.env.CA_PROJECT_MONGO_USERNAME || "root",
        password: process.env.CA_PROJECT_MONGO_PASSWORD || "",
        dbName: process.env.CA_PROJECT_MONGO_DB_NAME || "auth",
        templateUri:
    ...
    redis: {
        host: process.env.CA_PROJECT_REDIS_HOST || "127.0.0.1",
        port: process.env.CA_PROJECT_REDIS_PORT || "6380",
        username: process.env.CA_PROJECT_REDIS_USERNAME || "",
        password: process.env.CA_PROJECT_REDIS_PASSWORD || "",
    },
    keys: {
        public: process.env.CA_PROJECT_PUBLIC_KEY || "",
    ...
    log: {
        ...
        logstashPort: process.env.CA_PROJECT_LOG_LOGSTASH_PORT || "50001",
        logstashProtocol: process.env.CA_PROJECT_LOG_LOGSTASH_PROTOCOL || "udp",
    },
    saltRounds: process.env.CA_PROJECT_SALT_ROUNDS || "10",
    services: {
        ad: {
            prefix: process.env.CA_PROJECT_AD_SERVICE_PREFIX || "/api/v1/in/",
            host: process.env.CA_PROJECT_AD_SERVICE_HOST || "http://127.0.0.1",
            port: process.env.CA_PROJECT_AD_SERVICE_PORT || "6801",
