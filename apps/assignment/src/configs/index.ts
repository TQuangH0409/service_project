...
export const configs = {
    ...
    log: {
        ...
        folderLogsPath:
            process.env.CA_ASSIGNMENT_FOLDER_LOGS_PATH || `${__dirname}/../../logs`,

        logstashEnabled: process.env.CA_ASSIGNMENT_LOG_LOGSTASH_ENABLED || "false",
        logstashHost: process.env.CA_ASSIGNMENT_LOG_LOGSTASH_HOST || "127.0.0.1",
        logstashPort: process.env.CA_ASSIGNMENT_LOG_LOGSTASH_PORT || "50001",
        logstashProtocol: process.env.CA_ASSIGNMENT_LOG_LOGSTASH_PROTOCOL || "udp",
    },
    saltRounds: process.env.CA_ASSIGNMENT_SALT_ROUNDS || "10",
    services: {
        ad: {
            prefix: process.env.CA_ASSIGNMENT_AD_SERVICE_PREFIX || "/api/v1/in/",
            host: process.env.CA_ASSIGNMENT_AD_SERVICE_HOST || "http://127.0.0.1",
        ...
        mail: {
            prefix:
                process.env.CA_ASSIGNMENT_MAIL_SERVICE_PREFIX || "/api/v1/in/mail",
            host: process.env.CA_ASSIGNMENT_MAIL_SERVICE_HOST || "http://127.0.0.1",
        ...
        file: {
            prefix:
                process.env.CA_ASSIGNMENT_FILE_SERVICE_PREFIX || "/api/v1/in/files",
